...
<h1 class="font-bold" > My Profile</h1>
    <hr class="h-px my-8 bg-gray-200 border-2 dark:bg-gray-700">
        <div class=" w-full border-slate-200 rounded-xl shadow-md p-5">
            <form action="">
            <label for="crete">
            ...
            <label class="block mb-2 text-sm font-bold text-gray-900 dark:text-white" for="file_input">Upload Picture</label>
            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file">
                </div>
    <hr class="h-px my-8 bg-gray-200 border-2 dark:bg-gray-700">
    <button class="my-10 bg-sky-500 px-5 ml-9 py-2 rounded-full text-white font-semibold block mx-auto hover:bg-sky-600">Save</button>
    </div>
