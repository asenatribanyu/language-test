...
@section('content')
    <div class="flex justify-center items-center">
        <div
            ...
            <div class="mt-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="text-input">Structure
                    Question</label>
                <input id="text-input" type="text" placeholder="Enter the question of Structure Expression here"
