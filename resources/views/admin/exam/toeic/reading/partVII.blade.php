...
<div class="mt-3">
    ...
    <div class="mt-2 p-2 border-2 rounded-lg relative">
        ...
        <div class="absolute top-3 right-3">
            ...
            <a href="/admin/dashboard/exam/ept/direction//edit" onclick="updateLocalStorage('part vii')"
...
<div class="mt-3">
    <div class="flex items-center">
        <h2 class="text-xl font-medium dark:text-white">Question of Listening Part VII:</h2>
        <span
            class="inline-flex items-center justify-center w-6 h-6 ms-2 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full">
            10
        </span>
    </div>
    <div class="mt-2 p-5 border-2 rounded-lg relative">
        <div>
            <div>
                <div class="mt-1.5">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <form class=" flex justify-center" action="/admin/dashboard/exam/question/"
                                    ...
                                    <button data-modal-hide="delete-exam-" type="button"
                                        class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                                        cancel</button>
                                </form>
                            </div>
