                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 text-center md:p-5">
                                    ...
                                    <form action="/admin/dashboard/exam/control/{{ $examOpen->id }}" method="POST">
                                        ...
                                        <input type="hidden" value="{{ $examOpen->exam->category }}" name="category">
                                        <button data-modal-hide="end-modal" type="submit"
                                ...
                                <tr class="border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <img class="object-cover w-10 h-10 rounded-full"
                                            src="{{ asset('storage/' . $enroll->user->picture) }}" alt="profile_picture">
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $enroll->user->name }}
                                    </td>
                                            ...
                                            <div class="relative w-full max-w-md max-h-full p-4">
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div class="p-4 text-center md:p-5">
                                                        ...
                                                        <form action="/dashboard/waiting-area/jadwal/{{ $enroll->id }}"
                                                            method="POST">
                                                            @method('put')
                                                            @csrf
