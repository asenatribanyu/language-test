{{-- Part I --}}
<div class="mt-3">
    <h2 class="text-xl font-medium dark:text-white" id="partIV">Direction of Listening Part IV:</h2>
    <div class="mt-2 p-2 border-2 rounded-lg relative">
        ...
        <div class="absolute top-3 right-3">
            ...
            <a href="/admin/dashboard/exam/ept/direction//edit" onclick="updateLocalStorage('part iv')"
