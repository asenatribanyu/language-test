                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="-mt-2">
                        <label for="first-date"
                            class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">First
                            Date</label>
                        <div class="relative max-w-sm">
                            ...
                            <input datepicker datepicker-autohide type="text" id="first-date" name="first_date"
                    ...
                    <div>
                        <label for="second-date"
                            class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Second
                            Date</label>
                        <div class="relative max-w-sm">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                            ...
                            <input datepicker datepicker-autohide type="text" id="second-date" name="second_date"
                                datepicker-format="dd/mm/yyyy"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        <label for="third-date"
                            class="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Third
                            Date</label>
                        <div class="relative max-w-sm">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                            ...
                            <input datepicker datepicker-autohide type="text" id="third-date" name="third_date"
                                datepicker-format="dd/mm/yyyy"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        <label for="first-time"
                            ...
                            Time Slot</label>
                        <div
                            class="flex gap-1 items-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <svg class="w-4 h-4 ms-3 text-gray-500 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path
                            ...
                            <div class="flex items-center gap-1">
                                <select id="hour" name="hour_1"
                                    class="bg-gray-50 border-none text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
