...
@section('content')
    <div
        class="mt-7 p-5 max-w-screen-md mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="border-b-2 border-gray-200">
            <h1 class="pb-2 text-2xl font-semibold dark:text-white">My Profile</h1>
        </div>
        <div class="mt-5">
            <div class="mb-5">
                <img class="w-52 h-52 object-cover rounded-lg" src="{{ asset('') }}" alt="">
            </div>
            <div class="mb-5">
                <form action="">
            ...
            <div class="mb-5">
                <label for="program_study" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Program
                    Study</label>
