                ...
                <div class="flex gap-5">
                    ...
                    <div class="absolute top-3 right-3">
                        ...
                        <a href="/admin/dashboard/exam/ept/question/{{ $question->id }}/edit"
                            onclick="updateLocalStorage('part a')"
                            class="text-white bg-white px-2 py-2 text-xs hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-center inline-flex items-center dark:bg-white dark:border-gray-700 dark:text-white dark:focus:ring-gray-700 dark:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg"
