    ...
    <div class="p-5 mt-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="mt-5 mb-5 dark:border-gray-700 dark:bg-gray-900">
            ...
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400">2. Extract file<a class="font-semibold text-gray-950">
                        SEB-WidyatamaLanguageInstitute.zip</a></p>
                <p class="text-gray-500 dark:text-gray-400">3. Install Aplikasi yang bernama<a
                        class="font-semibold text-gray-950"> SEB_3.4.1.505_SetupBundle.exe</a></p>
                ...
                <p class="text-gray-500 dark:text-gray-400">6. Install Aplikasi yang bernama<a
                        class="font-semibold text-gray-950"> SebClientSettings-WidyatamaLanguageInstitute.seb</a>
                </p>
                ...
                <p class="text-gray-500 dark:text-gray-400">8. Jika ingin keluar aplikasi SEB silahkan tekan
                    kombinasi<a class="font-semibold text-gray-950"> CTRL + Q</a></p>
            ...
            <p class="mt-2 text-gray-500 dark:text-gray-400">Jika ada informasi yang kurang jelas silahkan
