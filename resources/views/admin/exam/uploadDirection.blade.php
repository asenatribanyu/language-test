...
@section('content')
    <div class="flex justify-center items-center">
        <div
            ...
            <div class="mt-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Audio Direction
                    (Optional)</label>
                <input
            ...
            <div class="mt-5 pb-5 border-b-2 border-gray-200">
                ...
                <select id="select-section"
                    ...
                    <option value="">Listening Comperhension Part A</option>
                    <option value="">Listening Comperhension Part B</option>
                    <option value="">Listening Comperhension Part C</option>
