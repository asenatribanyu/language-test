{{-- Part I --}}
<div class="mt-3">
    <h2 class="text-xl font-medium dark:text-white" id="partII">Direction of Listening Part II:</h2>
    <div class="mt-2 p-2 border-2 rounded-lg relative">
        ...
        <div class="absolute top-3 right-3">
            <button type="button" data-modal-target="delete-direction-" data-modal-toggle="delete-direction-"
            ...
            <a href="/admin/dashboard/exam/ept/direction//edit" onclick="updateLocalStorage('part ii')"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <form class=" flex justify-center" action="/admin/dashboard/exam/ept/question/"
                                method="POST">
                                @method('delete')
                                @csrf
                                <button data-modal-hide="delete-direction-" type="submit"
                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                    Yes, I'm sure
                                </button>
                                <button data-modal-hide="delete-direction-" type="button"
...
<div class="mt-3">
    <div class="flex items-center">
        <h2 class="text-xl font-medium dark:text-white">Question of Listening Part II:</h2>
        <span
            ...
            <div>
                ...
                <div class="mt-3 ms-1">
                    <div class="flex items-center mb-4">
                        ...
                        <label for="radio-a" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jawaban
                            A</label>
                    </div>
                    <div class="flex items-center mb-4">
                        <input id="radio-b" type="radio" disabled
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="radio-b" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jawaban
                            B</label>
                    </div>
                    <div class="flex items-center mb-4">
                        <input id="radio-c" type="radio" disabled
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="radio-c" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jawaban
                            C</label>
                    </div>
                    <div class="flex items-center">
                        <input id="radio-d" type="radio" disabled
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="radio-d" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jawaban
                            D</label>
                    </div>
                </div>
            </div>
            <div class="absolute top-3 right-3">
                <button type="button" data-modal-target="delete-question-" data-modal-toggle="delete-question-"
                ...
                {{-- Delete Modal --}}
                <div id="delete-question-" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button type="button"
                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                data-modal-hide="delete-question-">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <form class=" flex justify-center" action="/admin/dashboard/exam/question/"
                                    ...
                                    @method('delete')
                                    @csrf
                                    <button data-modal-hide="delete-question-" type="submit"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                        Yes, I'm sure
                                    </button>
                                    <button data-modal-hide="delete-question-" type="button"
                                        class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                                        cancel</button>
                                </form>
                            </div>
