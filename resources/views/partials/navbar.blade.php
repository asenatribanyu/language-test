    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center md:order-2">
            <button type="button"
                ...
                <img class="w-10 h-10 object-cover rounded-full" src="{{ asset('img/no_avatar.png') }}" alt="logo">
            </button>
            <!-- Dropdown menu -->
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                ...
                <ul class="py-2" aria-labelledby="user-menu-button">
                    ...
                    <button id="doubleDropdownButton" data-dropdown-toggle="doubleDropdown"
                        ...
                        class="flex items-center justify-between w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Test
                        History<svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
