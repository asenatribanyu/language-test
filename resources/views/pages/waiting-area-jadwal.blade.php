    ...
    <div class="w-full flex gap-5 max-md:block">
        <div
            ...
            <div class="mt-5 flex justify-center">
                <img class="w-24 h-24 object-cover rounded-full bg-gray-50" src="{{ asset('') }}" alt="profile-picture">
            </div>
            <div class="font-semibold">
                <div class="flex mt-5">
                    <div class="w-1/3">Registrant</div>
                    <div class="w-1/3">:</div>
                    <div class="w-1/2 -ms-32 max-md:-ms-20 font-normal border-b border-gray-200">Widyatama Student</div>
                </div>
                <div class="flex mt-5">
                    <div class="w-1/3">Name</div>
                    <div class="w-1/3">:</div>
                    <div class="w-1/2 -ms-32 max-md:-ms-20 font-normal border-b border-gray-200">Muhammad Rizaldy Alfarez
                    </div>
                </div>
                <div class="flex mt-5">
                    <div class="w-1/3">NPM</div>
                    <div class="w-1/3">:</div>
                    <div class="w-1/3 -ms-32 max-md:-ms-20 font-normal border-b border-gray-200">0620101035</div>
                </div>
                <div class="flex mt-5">
                    <div class="w-1/3">Faculty</div>
                    <div class="w-1/3">:</div>
                    <div class="w-1/3 -ms-32 max-md:-ms-20 font-normal border-b border-gray-200">Engineering</div>
                </div>
                <div class="flex mt-5">
                    <div class="w-1/3">Program Study</div>
                    <div class="w-1/3">:</div>
                    <div class="w-1/3 -ms-32 max-md:-ms-20 font-normal border-b border-gray-200">Informatics S1</div>
                </div>
            </div>
