{{-- Part I --}}
<div class="mt-3">
    <h2 class="text-xl font-medium dark:text-white" id="partI">Direction of Listening Part I:</h2>
    <div class="mt-2 p-2 border-2 rounded-lg relative">
        ...
        <div class="absolute top-3 right-3">
            ...
            <a href="/admin/dashboard/exam/ept/direction//edit" onclick="updateLocalStorage('part i')"
...
<div class="mt-3">
    <div class="flex items-center">
        <h2 class="text-xl font-medium dark:text-white">Question of Listening Part I:</h2>
        <span
                ...
                <div class="mt-3 ms-1">
                    ...
                    <div class="flex items-center">
                        <input id="radio-d" type="radio" disabled
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="radio-d"
                            class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jawaban
                            D</label>
                    </div>
                </div>
            </div>
